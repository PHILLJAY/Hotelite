        ...
        <div class="fields">
            <form action="src/includes/login.inc.php" method="POST">
                <div class="username"> <svg class="svg-icon" viewBox="0 0 20 20">
                    ...
                    </svg><input type="username" name="username" class="user-input" placeholder="username/email" required/></div>
                <div class="password"> <svg class="svg-icon" viewBox="0 0 20 20">
                    ...
                    </svg><input type="password" name="password" class="pass-input" placeholder="password" required/></div>
